...
public class scrollnslide extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    // Creates a grid pane for labeled sliders
    ...
    // Puts nodes in a border pane
    BorderPane pane = new BorderPane();
    pane.setTop(paneForText);
    pane.setCenter(paneForSliders);

    Scene scene = new Scene(pane, 250, 150);
    primaryStage.setTitle("scrollnslide"); // Sets the stage title
